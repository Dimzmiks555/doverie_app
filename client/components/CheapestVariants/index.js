        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="main-title">
              ...
              <p>
                Варианты, выставленные недавно.{" "}
                <Link href="/catalog?type=Квартира&kind=Продажа&rooms=1,2,3,4,5,6&priceFrom=null&priceTo=null">
                  <a className="float-right" href="#">
                    Показать всё <span className="flaticon-next"></span>
                  </a>
                </Link>
              </p>
            </div>
          </div>
          <div className="col-lg-12">Показать все</div>
        </div>
        {console.log(objects)}
        <div className="row">
