...
export default function Home() {
  ...
  useScript('/js/bootstrap-select.min.js.js');
  useScript('/js/jquery-migrate-3.0.0.min.js');
  useScript('/js/popper.min.js');
				...
				<div class="col-lg-12">
					<div class="feature_property_home3_slider">
						...
						<div class="item">
							<div class="feat_property home3">
								<div class="thumb">
									<img class="img-whp" src="images/property/fp2.jpg" alt="fp2.jpg"></img>
									<div class="thmb_cntnt">
										<ul class="tag mb0">
											<li class="list-inline-item"><a href="#">For Rent</a></li>
						...
						<div class="item">
							<div class="feat_property home3">
								<div class="thumb">
									<img class="img-whp" src="images/property/fp3.jpg" alt="fp3.jpg"></img>
									<div class="thmb_cntnt">
										<ul class="tag mb0">
			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-4 col-xl">
					<div class="properti_city">
						<div class="thumb"><img class="img-fluid w100" src="images/property/pc7.jpg" alt="pc7.jpg"></img></div>
						<div class="overlay">
							<div class="details">
								<h4>Miami</h4>
								<p>24 Properties</p>
				...
				<div class="col-sm-6 col-md-4 col-lg-4 col-xl">
					<div class="properti_city">
						<div class="thumb"><img class="img-fluid w100" src="images/property/pc8.jpg" alt="pc8.jpg"></img></div>
						<div class="overlay">
							<div class="details">
								<h4>Los Angeles</h4>
								<p>18 Properties</p>
				...
				<div class="col-sm-6 col-md-4 col-lg-4 col-xl">
					<div class="properti_city">
						<div class="thumb"><img class="img-fluid w100" src="images/property/pc9.jpg" alt="pc9.jpg"></img></div>
						<div class="overlay">
							<div class="details">
								<h4>New York</h4>
								<p>89 Properties</p>
				...
				<div class="col-sm-6 col-md-4 col-lg-4 col-xl">
					<div class="properti_city">
						<div class="thumb"><img class="img-fluid w100" src="images/property/pc10.jpg" alt="pc10.jpg"></img></div>
						<div class="overlay">
							<div class="details">
								<h4>Florida</h4>
								<p>47 Properties</p>
				...
				<div class="col-sm-6 col-md-4 col-lg-4 col-xl">
					<div class="properti_city">
						<div class="thumb"><img class="img-fluid w100" src="images/property/pc11.jpg" alt="pc11.jpg"></img></div>
						<div class="overlay">
							<div class="details">
								<h4>Orlando</h4>
								<p>89 Properties</p>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4">
					<div class="feat_property home3">
						<div class="thumb">
							<img class="img-whp" src="images/property/fp6.jpg" alt="fp6.jpg"></img>
							<div class="thmb_cntnt">
								<ul class="tag mb0">
									<li class="list-inline-item"><a href="#">For Rent</a></li>
									<li class="list-inline-item dn"></li>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg col-xl">
					<div class="footer_contact_widget home3">
						<h4>Contact Us</h4>
						<ul class="list-unstyled">
							<li><a href="#"><span class="__cf_email__" data-cfemail="9bf2f5fdf4dbfdf2f5fff3f4eee8feb5f8f4f6">[email&#160;protected]</span></a></li>
					...
					<div class="footer_social_widget home3">
						...
						<form class="footer_mailchimp_form home3">
						 	<div class="form-row align-items-center">
							    <div class="col-auto">
							    	<input type="email" class="form-control mb-2" id="inlineFormInput" placeholder="Your email"></input>
							    </div>
							    <div class="col-auto">
