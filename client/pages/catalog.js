				...
				<div class="col-lg-6">
					<div class="breadcrumb_content style2 mb0-991">
						{/* <ol class="breadcrumb">
						    ...
						    <li class="breadcrumb-item active text-thm" aria-current="page">Каталог</li>
						</ol> */}
						<h2 class="breadcrumb_title">Каталог</h2>
					</div>
				</div>
				{/* <div class="col-lg-6">
						...
						<div class="grid_list_search_result">
							...
							<div class="col-sm-12 col-md-8 col-lg-8 col-xl-7">
								<div class="right_area text-right tac-xsd">
									<ul>
										<li class="list-inline-item"><span class="stts" style={{marginRight: '10px'}}>Статус:</span>
										...
										<li class="list-inline-item" ><span class="shrtby" style={{marginRight: '10px'}}>Сортировать:</span>
											<select class="selectpicker show-tick">
